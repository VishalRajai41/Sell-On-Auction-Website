...
if(isset($btnsave))
{
	@mysqli_query($con,"insert into user_m(uname,email,password,city,phone,approval) values('$name','$email','$pass','$listcity','$phone','')") or die(mysqli_error($con));
	$msg="Record Inserted...";
		...
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				...
				<!--div class="wrap-input100 validate-input" data-validate="Username is required">
					...
					<div>
						<span class="label-input100">City</span><br><br>
						<select name="listcity">
								<option name=Bhavnagar>Bhavnagar</option>
								<option name=Banglore>Banglore</option>	
								<option name=Ahmedabad>Ahemdabad</option>
						...
						<div class="wrap-input100 validate-input" data-validate = "Contact No is required">
							<br><span class="label-input100">Contact No</span>
