					...
					<table data-vertable="ver1">
						...
						<tbody>
								...
								<?php
									include("connect.php");
									extract($_REQUEST);
									$result=mysqli_query($con,"select * from selling") or die(mysql_error($con));
								while($row=mysqli_fetch_array($result))
								{
									echo "<tr class='row100'>";
									echo "<td class=' column1' data-column='column1'><img src='$row[5]' height=150px width=200px></td>";
									echo "<td class='column100 column2' data-column='column2'>$row[3]</td>";
									echo "<td class='column100 column3' data-column='column3'>$row[6]</td>";
